        ...
        <div className="bg-white w-full shadow rounded">
            ...
            <div className="p-4 flex flex-col items-center">
                ...
                <div className="inline-flex items-center mt-2">
                    ...
                    <div className="bg-gray-100 border-t border-b border-gray-100 text-gray-600 hover:bg-gray-100 inline-flex items-center px-4 py-1 select-none">{quantity}</div>
