    ...
    return (
        <div className="bg-white w-72 shadow rounded">
            ...
            <div className="p-4 flex flex-col items-center">
                ...
                <button onClick={() => { handleSelectComponent; router.push("/builder") }} className="py-2 px-4 bg-blue-500 text-white rounded capitalize hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50 mt-4 w-full flex items-center justify-center">
                    Add to pc Builder
